...
def procesar_Datos(datos_Brutos: list, latitud: list, longitud: list, rutas_audios: list, rutas_fotos: list)->list:
	...
	direccion = obtener_direccion(latitud, longitud) # devuelve lista de dirección tras procesar latitud y longitud
	patentes: str = validar_patentes(rutas_fotos) # devuelve lista de patentes tras procesar imágenes
